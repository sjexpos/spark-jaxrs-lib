 ...
 */
public class SingleValueExtractor<T> extends AbstractParamValueExtractor<T> {

	public SingleValueExtractor(ParamConverter<T> paramConverter, String parameterName, String defaultValueString) {
		super(paramConverter, parameterName, defaultValueString);
	}
